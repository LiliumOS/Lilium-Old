...
set(PHANTOM_TARGET_NAME ${CMAKE_SYSTEM_PROCESSOR}-pc-none-elf)
...
find_program(CMAKE_RANLIB NAMES ${PHANTOM_TARGET_NAME}-ranlib llvm-ranlib ${PHANTOM_TARGET_NAME}-llvm-ranlib ranlib
        REQUIRED)
find_program(CMAKE_LINKER NAMES ld.lld ${PHANTOM_TARGET_NAME}-ld.lld ${PHANTOM_TARGET_NAME}-ld ld
        REQUIRED)
...
set(CMAKE_EXE_LINKER_FLAGS "-nostdlib -fuse-ld=${CMAKE_LINKER}")
